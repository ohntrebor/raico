...
def openai_pr_review_file_inline(ai_api_key, github_token, repo_name, pr_number, prompt_path, ai_model="gpt-4"):
    """
    Função para revisar um arquivo inteiro alterado em um Pull Request (PR) utilizando a API OpenAI,
